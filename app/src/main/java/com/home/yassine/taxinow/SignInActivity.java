 ...
 */
public class SignInActivity extends AppCompatActivity implements ExternalAuthFragment.OnFragmentInteractionListener, IErrorText, IProgressShow {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            try {
                ...
                client.post(this, HttpClient.BASE_URL+"auth/login", entity, "application/json", new AsyncHttpResponseHandler() {
                    @Override
                    public void onStart() {
                        Log.e("d", "START");
                    }
